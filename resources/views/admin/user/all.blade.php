                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        @else
                        <img height="30" class="" src="{{asset('contents/admin')}}/images/avatar.png" alt="avatar"/>
                        @endif
                      </td>
                    <td>
                          <div class="btn-group btn_group_manage" role="group">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li><a class="dropdown-item" href="#" id="softDelete" data-bs-toggle="modal" data-bs-target="#softdeleteModal" data-mamun="{{$data->id}}">Delete</a></li>
                            </ul>
                          </div>
                      </td>
                    </tr>
