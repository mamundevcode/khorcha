          ...
          <div class="card-header">
            <div class="row">
              <div class="col-md-8 card_title_part">
                <i class="fab fa-gg-circle"></i> Recycle Income Category
              </div>
            ...
            <table class="table table-bordered table-striped table-hover custom_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <li><a href="#" id="restore" data-bs-toggle="modal" data-bs-target="#restoreModal" data-id="{{$data->income_id}}"><i class="fas fa-recycle fs-5 text-success fw-bold mx-6"></i></a></li>
                    <li><a href="#" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{$data->income_id}}"><i class="fas fa-trash fs-5  text-danger fw-bold mx-6"></i></a></li>
                  </td>
                </tr>
                @endforeach
              </tbody>
