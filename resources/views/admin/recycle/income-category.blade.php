        ...
        <table class="table table-bordered table-striped table-hover custom_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              <li><a href="#" id="restore" data-bs-toggle="modal" data-bs-target="#restoreModal" data-id="{{$data->incate_id}}"><i class="fas fa-recycle fs-5 text-success fw-bold mx-6"></i></a></li>
              <li><a href="#" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{$data->incate_id}}"><i class="fas fa-trash fs-5  text-danger fw-bold mx-6"></i></a></li>
              </td>
            </tr>
            @endforeach
          </tbody>
  ...
  <div class="modal-dialog">
    <form method="post" action="{{url('dashboard/income/category/delete')}}">
      ...
      <div class="modal-header modal_header">
        ...
        <div class="modal-body modal_body">
          Are you want to sure jindegir jonno delete data?
          <input type="hidden" name ="modal_id" id ="modal_id">
        </div>
        <div class="modal-footer modal_footer">
          <button type="submit" class="btn btn-sm btn-success">Confirm</button>
